        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav mx-auto">
                    ...
                    <a href="about.html" class="nav-item nav-link">유치원 소개</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 rounded-bottom border-0 shadow-sm m-0">
                            <a href="facility.html" class="dropdown-item">상담 예약</a>
                            <a href="team.html" class="dropdown-item">수업 예약</a>
                        </div>
                    </div>
                    <a href="contact.html" class="nav-item nav-link">활동 일지</a>
                    <a href="contact.html" class="nav-item nav-link">온라인 상담</a>
                </div>
