...
function date_click(event) {
    ...
    let param = event.data.year + String(event.data.month).padStart(2, "0") +String(event.data.day).padStart(2, "0")
    $(reserveForm.redate).val(param);
    fetch('/dangdangdang/reservation/getReservation.jsp?date=' + param)
