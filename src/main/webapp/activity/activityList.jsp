        ...
        <section class="container-xxl py-5 ftco-section">
			<div class="container">
				<div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
	                    <h1 class="mb-3">Activity Report List</h1>
	             </div>
	        </div>
	        <div class="container">
			...
			<div class="row g-5">
				<div class="col-md-12">
					<table class="table table-bordered">
						...
						<tbody>
							<c:forEach items="${activityList}" var="activity" varStatus="stat">
								<tr>
									<td>${ stat.count}</td>
									<td>${activity.no}</td>
									<td>${activity.teacherId}</td>
									<td>${activity.activityDate.substring(0, 16)}</td>
									<td>${activity.regDate.substring(0, 16)}</td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
